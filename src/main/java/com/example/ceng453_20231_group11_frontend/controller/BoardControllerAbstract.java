...
abstract class BoardControllerAbstract implements Initializable {
    ...
    protected void initializeCircles() {
        ...
        circleMap.put(circle2, new CircleVertex(Arrays.asList(circle32, circle24, circle27), Arrays.asList(tile11, tile12, tile16)));
        circleMap.put(circle3, new CircleVertex(Arrays.asList(circle25, circle34, circle49), Arrays.asList(tile17, tile18)));
        circleMap.put(circle4, new CircleVertex());
        circleMap.put(circle5, new CircleVertex());
        circleMap.put(circle6, new CircleVertex(Arrays.asList(circle49, circle35), Arrays.asList(tile17)));
        circleMap.put(circle7, new CircleVertex());
        circleMap.put(circle8, new CircleVertex(Arrays.asList(circle33, circle10, circle37), Arrays.asList(tile19, tile15, tile18)));
        circleMap.put(circle9, new CircleVertex());
        circleMap.put(circle10, new CircleVertex(Arrays.asList(circle8, circle28, circle21), Arrays.asList(tile19, tile18)));
        ...
        circleMap.put(circle16, new CircleVertex(Arrays.asList(circle26, circle25, circle35), Arrays.asList(tile17, tile14, tile13)));
        ...
        circleMap.put(circle24, new CircleVertex(Arrays.asList(circle53, circle36, circle2), Arrays.asList(tile12, tile16)));
        circleMap.put(circle25, new CircleVertex(Arrays.asList(circle37, circle16, circle3), Arrays.asList(tile18, tile14, tile17)));
        circleMap.put(circle26, new CircleVertex());
        circleMap.put(circle27, new CircleVertex(Arrays.asList(circle2, circle21, circle33), Arrays.asList(tile16, tile15, tile11)));
        circleMap.put(circle28, new CircleVertex(Arrays.asList(circle41, circle10), Arrays.asList(tile19)));
        ...
        circleMap.put(circle33, new CircleVertex(Arrays.asList(circle27, circle39, circle8), Arrays.asList(tile16, tile19, tile15)));
        circleMap.put(circle34, new CircleVertex(Arrays.asList(circle3, circle10), Arrays.asList(tile18)));
        circleMap.put(circle35, new CircleVertex(Arrays.asList(circle6, circle16, circle48), Arrays.asList(tile17, tile13)));
        circleMap.put(circle36, new CircleVertex(Arrays.asList(circle24, circle39), Arrays.asList(tile16)));
        circleMap.put(circle37, new CircleVertex(Arrays.asList(circle8, circle14, circle25), Arrays.asList(tile18, tile15, tile14)));
        circleMap.put(circle38, new CircleVertex());
        circleMap.put(circle39, new CircleVertex(Arrays.asList(circle36, circle41, circle33), Arrays.asList(tile16, tile19)));
        circleMap.put(circle40, new CircleVertex());
        circleMap.put(circle41, new CircleVertex(Arrays.asList(circle39, circle28), Arrays.asList(tile19)));
        ...
        circleMap.put(circle49, new CircleVertex(Arrays.asList(circle3, circle6), Arrays.asList(tile17)));
